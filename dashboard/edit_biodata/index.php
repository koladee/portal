...
if(isset($_SESSION['status'], $_SESSION['uniqid'])){
    if(isset($_POST['std'])){
         $st = $db->query('select * from users where uniqid = "'.$_SESSION['uniqid'].'" and status = "ict"');
        $count = $st->rowCount();
        if($count == 1){
            $stmt = $db->query('select * from users where uid = "'.$_POST['std'].'"');
                if($stmt->rowCount() == 1){
        //fetch form
...
<div class="col-lg-12" style="width: 100%; padding: 0px;">
    ...
    <div class="col-sm-4" style="padding: 0px;">
				<p>
					<label for="firstname">Firstname</label>
                                        <input type="text" id="firstname" value="<?php echo $dat['firstname']; ?>" name="firstname" class="round full-width-input" />
				</p>
    </div>
    <div class="col-sm-4" style="padding: 0px;">
				<p>
					<label for="middlename">Middlename</label>
                                        <input type="text" id="middlename" value="<?php echo $dat['middlename']; ?>" name="middlename" class="round full-width-input"/>
				</p>
    </div>
    <div class="col-sm-4" style="padding: 0px;">
				<p>
					<label for="lastname">Lastname</label>
                                        <input type="text" id="lastname" value="<?php echo $dat['lastname']; ?>" name="lastname" class="round full-width-input"/>
				</p>
    </div>
           ...
           <center>
                                     ...
                                     <br><br>
                                                <span class="fileContainer" style="cursor: pointer;  margin-top: 25px;">
                                                        ...
                                                        <input onchange="" id="upload1" type='file' name="filez">
    ...
    <div class="col-sm-4" style="padding: 0px;">
				<p>
					<label for="email">Email</label>
                                        <input type="email" id="email" value="<?php echo $dat['email']; ?>" name="email" class="round full-width-input"/>
				</p>
    </div>
    <div class="col-sm-4" style="padding: 0px;">
				<p>
					<label for="mobile">Mobile</label>
                                        <input type="text" id="mobile" value="<?php echo $dat['mobile']; ?>" name="mobile" class="round full-width-input"/>
				</p>
    </div>
   ...
   <?php if($dat['status'] == "student"){ ?>                     
    <div class="col-sm-8" style="padding: 0px;">
				<p>
					<label for="course">Course of Study</label>
                                        <input type="text" id="course" value="<?php echo $dat['department']; ?>" name="course" class="round full-width-input" />
				</p>
   ...
   <?php } ?>                     			
    ...
    <?php }
        ...
        echo "<div class='error-box round'>No user with such id on this system!</div>";
