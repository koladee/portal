...
$stmt = $db->query('select * from users where uniqid = "'.$_SESSION['uniqid'].'" and status = "'.'student'.'"');
            ...
            if($row_count == 1 && $_POST['std'] == $_SESSION['uniqid']){
                $rows = $stmt->fetchAll(PDO::FETCH_ASSOC);
                $dat = $rows[0];
                ?>
<div class="col-lg-12" style="padding: 0px;">
    <div class="col-sm-3">
        <img src="<?php if($dat['gender'] == "male" && $dat['photo'] == ""){ ?>../im12ages784345/male.png<?php }elseif($dat['gender'] == "female" && $dat['photo'] == ""){ ?>../im12ages784345/male.png<?php }else{ echo "../".$dat['photo']; } ?>" style="width: 100px; height: 100px; border-radius: 50%;">
    </div>
    <div class="col-sm-9">
        <h5><?php echo $dat['firstname'].' '.$dat['middlename'].' '.$dat['lastname']; ?></h5>
        <h5><?php echo $dat['faculty']; ?></h5>
        <h5><?php echo $dat['department']; ?></h5>
        <h5><?php echo "Maximum Units: ".$dat['max_units']." units"; ?></h5>
        <?php 
...
//    $p_cgpa[0] = 0;
  ...
  ?>  
    ...
    <?php 
        ...
        $db->query('update users set cgpa = "'.$gpa.'" where uniqid = "'.$_SESSION['uniqid'].'"');
    ?>
  ...
  ?>  
    ...
    <?php 
        ...
        $db->query('update users set cgpa = "'.$n_cgpa.'" where uniqid = "'.$_SESSION['uniqid'].'"');
    ?>
    <div class="col-sm-12" style="padding: 0px; margin-top: 2%;">
        <table>
