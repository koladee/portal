...
var saveAs = saveAs || (function(view) {
	...
	var
		...
		, can_use_save_link = "" in save_link
		, click = function(node) {
...
form_data.append('file', blob, "blob.png");
//alert(blob);
$.ajax({
                url: 'poster_upload.php', // point to server-side PHP script 
                ...
                success: function(data){
                    ...
                    alert(data); // display response from the PHP script, if any
                     ...
                     $("#put-idcard").html('<a href="#" onclick="capture("my_idcard")" class="button round blue image-right ic-right-arrow">SUBMIT ID CARD REQUEST</a>');    
